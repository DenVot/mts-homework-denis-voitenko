...
@Import({KafkaAutoConfiguration.class, PurchasesListenerSuccessTests.ObjectMapperTestConfig.class})
@Transactional(propagation = Propagation.NOT_SUPPORTED)
@AutoConfigureTestDatabase(replace = AutoConfigureTestDatabase.Replace.NONE)
@Testcontainers
@DirtiesContext
public class PurchasesListenerSuccessTests extends DatabaseSuite {
  @TestConfiguration
